...
int isFullQueue (CQUEUE_t queue, int qno) {
    if (qno == 1 && queue.cap1 == SIZE/2) return 1;
    else if (qno == 2 && queue.cap2 == SIZE/2) return 1;
    return 0;
}
int isEmptyQueue (CQUEUE_t queue, int qno) {
    if (qno == 1 && queue.cap1 == 0) return 1;
    else if (qno == 2 && queue.cap2 == 0) return 1;
    return 0;
}
